...
function registerNewUser() {
    ...
    if (login != "" && password != "" && nome != "" && email != "" && telefone != "") {//checa se o usuario preencheu os dados de login e senha
        ...
        listaUsuarios['usuarios'].push({ "id": id, "name": nome, "email": email, "phone": telefone, "login": login, "password": password });// adiciona novo usuario
...
function displayProducts() {
    ...
    for (let i = 0; i < listaEquipamentos.equipamentos.length; i++) { //Percorre o vetor de chaves e para cada chave encontrada, executa o código abaixo
